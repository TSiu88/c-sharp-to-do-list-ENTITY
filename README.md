# _[C# To Do List Example](https://github.com/TSiu88/c-sharp-to-do-list-ENTITY)_

#### _To Do List Example with Entity, 3.18.2020_

#### By _**Tiffany Siu and Krista Rutz**_

[![Project Status: Inactive – The project has reached a stable, usable state but is no longer being actively developed; support/maintenance will be provided as time allows.](https://www.repostatus.org/badges/latest/inactive.svg)](https://www.repostatus.org/#inactive)
![LastCommit](https://img.shields.io/github/last-commit/tsiu88/c-sharp-to-do-list-ENTITY)
![Languages](https://img.shields.io/github/languages/top/tsiu88/c-sharp-to-do-list-ENTITY)
...
This project follows along with the class example of ToDoList until entity framework is used.
...
2. Clone the [repository](https://github.com/TSiu88/c-sharp-to-do-list-ENTITY.git) from my [GitHub page](https://github.com/TSiu88)
